...
**Terminal Aesthetic**
The portfolio mimics a terminal environment with ASCII art banners, command-line style navigation, and monospace typography using Fira Code and JetBrains Mono fonts.
